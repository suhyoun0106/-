      ...
      <ScrollHideUI direction="top" className="fixed top-0 left-0 right-0 z-50 pointer-events-none h-0">
        <div className="absolute top-[16px] left-[16px]">
          <div 
            ref={menuRef}
            className={cn(
              "relative pointer-events-auto flex flex-col items-center bg-white/70 dark:bg-black/70 border border-border/50 shadow-sm overflow-hidden transition-all duration-300 ease-out cursor-pointer",
        ...
        <div className="absolute top-[16px] right-[16px]">
          <div 
            ...
            className="pointer-events-auto flex items-center justify-center bg-white/70 dark:bg-black/70 border border-border/50 shadow-sm rounded-full w-[44px] h-[44px] cursor-pointer hover:bg-foreground/5 transition-colors"
            style={{ backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}
          >
